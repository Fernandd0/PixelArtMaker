...
let gridButton = document.getElementById("btn-submit-grid");
let clearGridButton = document.getElementById("btn-clear-grid");
let gridWidth = document.getElementById("width-range");
let gridHeight = document.getElementById("height-range");
let colorButton = document.getElementById("color-input");
let eraseBtn = document.getElementById("btn-erase");
let paintBtn = document.getElementById("btn-paint");
